        ...
        <div class="card">
            <form action="{{ route('admin.schedules.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="mentor" id="mentor" value="{{ old('mentor') }}" placeholder="Contoh: Pak Budi, Bu Ani" required>
                    @error('mentor')
                    <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="notes" id="notes" rows="3" placeholder="Catatan tambahan tentang jadwal ini">{{ old('notes') }}</textarea>
                    @error('notes')
                    <div class="error">{{ $message }}</div>
                    @enderror
                </div>
